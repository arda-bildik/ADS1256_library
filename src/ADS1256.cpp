...
//Constructor
ADS1256::ADS1256(int DRDY_pin, int RESET_pin, int SYNC_pin, int CS_pin, int MISO_pin, int CLK_pin, int MOSI_pin, float VREF) {
  if (CS_pin != 0) {
    _CS_pin = CS_pin;
  }
...
void ADS1256::InitializeADC() {
  ...
  delay(200);
  writeRegister(ADCON_REG, 0b00000000);  //ADCON - CLK: OFF, SDCS: OFF, PGA = 0 (+/- 5 V)
  delay(200);
  writeRegister(DRATE_REG, 0b10000100);  //100SPS
  delay(200);
